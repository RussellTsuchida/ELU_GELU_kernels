...
class gp_model:
    def __init__(self, kernel_type, data_noise, b_0_var=1., w_0_var=1., 
            w_1_var=2., u_var=1., g_var=1.,depth=2):
        ...
        self.w_1_var = w_1_var # second layer weight variance
    ...
    def run_inference(self, x_train, y_train, x_predict, print=False):
        ...
        kern = kernel(x_dim, [self.w_0_var,self.w_1_var], 0, 
                [self.b_0_var,0], 0, L = 1)
